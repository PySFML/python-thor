...
cdef extern from "pythor/vectors.h":
    cdef class thor.vectors.PolarVector2 [object PyPolarVector2Object]:
        cdef th.PolarVector2[NumericObject] *p_this

cdef extern from "pythor/vectors_api.h":
    int import_thor__vectors()

    cdef object wrap_polarvector2(th.PolarVector2[NumericObject]*)
